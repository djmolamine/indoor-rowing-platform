...
export function ExpeditionCatalogue() {
  ...
  return (
    <div>
      <header className="overflow-hidden rounded-[2rem] bg-[#0d2b24] px-5 py-8 text-white surface-grid sm:px-9 sm:py-11"><div className="max-w-3xl"><p className="flex items-center gap-2 text-xs font-black uppercase tracking-[.18em] text-[#9cc0b5]"><Compass size={17} /> Row the world</p><h1 className="display-type mt-4 text-4xl font-black leading-none sm:text-6xl">Eight waterways.<br /><span className="text-[#ff8055]">One lifelong journey.</span></h1><p className="mt-5 max-w-2xl text-sm leading-7 text-[#c4d7d1] sm:text-base">Expeditions turn every eligible indoor-rowing meter into movement through a real place, its history, and its living culture.</p></div></header>
